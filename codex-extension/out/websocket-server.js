...
class WebSocketServer {
    ...
    async start() {
        ...
        if (availablePort !== this.port) {
            ...
            vscode.window.showWarningMessage(`Codex Remote: 포트 ${this.port}가 사용 중이어서 포트 ${availablePort}로 시작합니다.`);
        }
        ...
        return new Promise((resolve, reject) => {
            this.wss.on("connection", (ws) => {
                ...
                ws.on("close", () => {
                    ...
                    this.log(`Client disconnected from Codex Remote (ID: ${disconnectedClientId})`);
            ...
            this.wss.on("error", (error) => {
                ...
                if (error.code === "EADDRINUSE") {
                    ...
                    vscode.window.showErrorMessage(`Codex Remote server error: ${error.message}`);
                    reject(error);
                }
            });
